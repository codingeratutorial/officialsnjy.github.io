...
<div class="container ">
	<div class="row justify-content-center">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
         ...
         <h4 class="tect-center text-info p-2"> User Search</h4>
...
<div class="container" id="contain">
		 ...
		 if(isset($_POST['sub'])){
			 include "confg.php";
			 $pro_id= $_POST['uid'];
            $q= "select * from  signup where username='$pro_id'";
...
<div class="container" id="contain">
         ...
         User ID<input type="text" name="name" id="name" class="form-control"  value="<?php echo $row['username'];?>"readonly>
		 
		 
          Password<input type="text" name="name" id="name" class="form-control" value="<?php echo $row['password'];?>"readonly>
		 
          Confirm Password<input type="text" name="name" id="name" class="form-control" value="<?php echo $row['conpassword'];?>"readonly >
