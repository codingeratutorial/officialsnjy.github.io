...
<div class="container ">
	<div class="row justify-content-center">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
         ...
         <h4 class="tect-center text-info p-2"> Search Orders By User ID</h4>

<div class="container" id="contain">
	   
	
         <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" class="post-form">
         <input type="text" name="ppid"  class="form-control" placeholder="Enter User ID" >
         <br>
		 ...
		 if(isset($_POST['sub'])){
			 include "confg.php";
			 $pro_id= $_POST['ppid'];
            $q= "select name, date, product,rupee, mode, Status , amount from  delivery where name='$pro_id' order by date desc";
...
<div class="container" id="contain">
         ...
         <form class="post-form" action="#" method="post">
          ...
          <div class="form-group"> <label for="cardName">
                                        <h6>Date</h6>
                                    </label><input type="date" name="name" id="name" class="form-control" value="<?php echo $row['date'];?>"readonly></div>
