...
<div class="container ">
	<div class="row justify-content-center">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
         ...
         <h4 class="tect-center text-info p-2"> Update Status</h4>
		 
	   <div class="container" id="contain">
	   
<?php 	
$q= "select transaction, amount, delivered from delivery where transaction='$tr'";
 ...
 if(mysqli_num_rows($fire)>0)
 {
	 while($row= mysqli_fetch_assoc($fire))
	 {
         ...
         Transaction ID<input type="text" name="name" id="name" class="form-control" value="<?php echo $tr ?>" readonly >
          <br>
		  
		  Amount Paid<input type="text" name="ampaid" id="ampaid"  class="form-control" value="<?php echo $row['amount']; ?>"   >
          <br>
          Status<select   class="form-control" name="status" >  
			<option required> --select-- </option>
			<option required> Paid </option>
        ...
        Delivery Date<input type="date" name="date" id="date" class="form-control" value="<?php echo $row['delivered'];  ?> "  ><br>
        
        Remark<input type="text" name="remark" id="remark" class="form-control" value="<?php echo $row['remark'];  ?> "  >
          <br>

            <input class="btn btn-danger" type="submit" name="sub" value="Confirm"><br><br>
