  ...
  header("Location:index.php");  //If any user directly access this page using url of this page then it can't open untill there is any     session 
	...
	if(!isset($_SESSION['uniquee']))
	{
     ...
     else
	 {
		...
		{
		unset($_SESSION['uniquee']);
		
	echo '<script> alert("Session Timeout");
 ...
 <link rel="stylesheet" href="file:///C:/xampp/htdocs/divisima/fontawesome-free-5.14.0-web/css/all.css" >
  ...
  <br><br>
         ...
         <div class="jumbotron p-3 mb-2 text-center" >
            ...
            <h4 class="tect-center text-info p-2 "> Payment Successful !!</h4>
            <h6 class="lead"><b>Transaction ID <b><?=$_SESSION['uniquee']; ?> </b><h6><br>
         	<h6 class="lead"><b>Thank You <b><?=$_SESSION['username']; ?> </b><h6>
			<h6 class="lead"><b>Your Products <b><?=$_SESSION['allItems']; ?></b>  has placed successfully and It will deliver within  7 days  </h6><br>
            <div>
         	
         	
         </div>
              <input class="btn btn-danger"  id="btn" value="Print Statement">  
         </div>
   ...
   <script src="printThis.js">  </script>
    ...
    pageTitle: "ORDER SUCCESSFULL",              // add title to print page
   ...
   $(document).ready(function(){
       ...
       $(".itemQty").on('change' , function(){
         ...
         $.ajax({
          ...
          method:'post',
          cache: false,
          data: {qtyy:qtyy, pid:pid ,pprice:pprice},
