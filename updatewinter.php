...
$q= "select * from winter where id='$pro_id'";
 ...
 if(mysqli_num_rows($fire)>0)
 {
	 ...
	 {
		 ?>
		 <form action="updateserwinter.php"  method="post">
         ...
         <div class="form-group">
		  ...
		  <div class="form-group">
         	Product Image<input type="file" name="pimage"value="<?php echo $row['product_image'];?>"class="form-control"  required=""><span id="error_email" style="color:red"></span>
         </div>
		  <div class="form-group">
