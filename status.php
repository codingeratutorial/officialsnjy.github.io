  		...
  		<nav class="main-navbar">
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="#">USER DETAIL</a>
						<ul class="sub-menu">
						    <li><a href="admin_user.php">All USERS</a></li>
							<li><a href="userser.php">SEARCH BY ID</a></li>
						...
						<ul class="sub-menu">
						   <li><a href="admin_product.php">STYLISH</a></li>
					...
					<li><a href="#">ORDERED DETAIL</a>
						<ul class="sub-menu">
						   <li><a href="admin_order.php">ALL ORDERS</a></li>
							<li><a href="userid.php">SEARCH BY USER ID</a></li>
							
							<li><a href="date.php">SEARCH BY DATE</a></li>
							<li><a href="mode.php">SEARCH BY MODE</a></li>
							<li><a href="status.php">SEARCH BY STATUS</a></li>
...
<div class="container ">
	<div class="row justify-content-center">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
         ...
         <h4 class="tect-center text-info p-2"> Search Orders By Status</h4>

<div class="container" id="contain">
	   
	
         <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" class="post-form">
                   Status<select   class="form-control" name="ppid" required>  
			<option required> --select-- </option>
			<option required> Full Paid </option>
			<option required> Unpaid </option>
			<option required> Unpaid Yet </option>
			<option required> Pending</option> 
			<option required> Refund</option>
		 ...
		 if(isset($_POST['sub'])){
			 include "confg.php";
			 $pro_id= $_POST['ppid'];
            $q= "select date, name, product,rupee, mode, Status, amount from  delivery where status='$pro_id'  order by date desc";
...
<div class="container" id="contain">
         ...
         <input type="date" name="name" id="name" class="form-control" value="<?php echo $row['date'];?>"readonly></div>
		 
		 <div class="form-group"> <label for="cardName">
                                        <h6>User ID</h6>
                                    </label><input type="text" name="name" id="name" class="form-control"  value="<?php echo $row['name'];?>"readonly></div>
         <div class="form-group"> <label for="cardName">
                                        <h6>Products</h6>
                                    </label> <input type="text" name="name" id="name" class="form-control" value="<?php echo $row['product'];?>"readonly ></div>
		 
         <div class="form-group"> <label for="cardName">
                                        <h6>Total Price</h6>
                                    </label><input type="text" name="name" id="name" class="form-control"value="<?php echo $row['rupee'];?>" readonly ></div>
		 
         <div class="form-group"> <label for="cardName">
                                        <h6>Mode</h6>
                                    </label><input type="text" name="name" id="name" class="form-control" value="<?php echo $row['mode'];?>"readonly ></div>
		 
		  <div class="form-group"> <label for="cardName">
                                        <h6>Amount Paid</h6>
                                    </label><input type="text" name="name" id="name" class="form-control" value="<?php echo $row['amount'];?>"readonly ></div>
		  <div class="form-group"> <label for="cardName">
                                        <h6>Status</h6>
                                    </label> <input type="text" name="name" id="name" class="form-control" value="<?php echo $row['Status'];?>"readonly ></div>
