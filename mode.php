...
<div class="container ">
	<div class="row justify-content-center">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
         ...
         <h4 class="tect-center text-info p-2"> Search Orders By Mode</h4>

<div class="container" id="contain">
	   
	
         <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" class="post-form">
                   Mode<select   class="form-control" name="ppid" required>  
			<option required> --select-- </option>
			<option required> COD</option>
			<option required> Credit/Debit Cards </option>
		 ...
		 if(isset($_POST['sub'])){
			 include "confg.php";
			 $pro_id= $_POST['ppid'];
            $q= "select date, name, product,rupee, mode, Status, amount from  delivery where mode='$pro_id'  order by date desc";
