...
include "confg.php";
 $q= "select transaction,date, delivery,product , rupee , mode, delivered, amount from delivery 
...
<div class="container">
         ...
         <h4 class="tect-center text-info p-2">YOUR ORDERS</h4>
...
<?php
    ...
    ?>   
 <!-- inside php ...name,email, phone is the column name of the given table in database-->
  ...
  <tr>
	 ...
	 <td> <?php echo $rows['rupee']  ?> </td>
       <td> <?php echo $rows['mode']  ?> </td>
	  
	    <td> <?php echo $rows['delivered']  ?> </td>
