...
<h6 class="display-4" style="text-align:center;">Stylish Collection</h6>
                 ...
                 <div class="card-deck">
                  <div class="card p-2 border-secondary mb-2">
                    ...
                    <div class="card-body p-1">
                      ...
                      <h5 class="card-text text-center text-danger"><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;&nbsp;<?=$row['product_price'] ?>/-</h5>
                    </div>
...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
   ...
   $.ajax({
    url: 'action.php',
    method :'post',
    data : {username:username,pid:pid,pname:pname,pprice:pprice,pimage:pimage,pcode:pcode},
